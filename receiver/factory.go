...
// IFactory can create ITraceReceiver and IMetricsReceiver. This is the
...
type IFactory interface {
	...
	// If the receiver type does not support tracing or if the config is not valid
	// error will be returned instead.
	CreateITraceReceiver(ctx context.Context, logger *zap.Logger, cfg configmodels.Receiver,
		nextConsumer consumer.ITraceConsumer) (TraceReceiver, error)

	// TODO: add CreateIMetricsReceiver.
}
