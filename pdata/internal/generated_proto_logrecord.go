...
func (orig *LogRecord) LazyMessage() *proto.LazyMessage {
	return &orig.lazy
}

// SetLazyParent records the parent lazy state used for modification bubbling.
func (orig *LogRecord) SetLazyParent(parent *proto.LazyMessage) {
...
func (orig *LogRecord) UnmarshalProto(buf []byte) error {
	if err := validateLogRecordProto(buf); err != nil {
		return err
	}
	orig.Reset()
...
func (orig *LogRecord) EnsureDecoded() {
...
func (orig *LogRecord) MarkModified() {
	orig.EnsureDecoded()
...
func validateLogRecordProto(buf []byte) error {
	var err error
	var fieldNum int32
...
func (orig *LogRecord) decodeProto(buf []byte) error {
	var err error
	var fieldNum int32
	var wireType proto.WireType
	...
	for pos < l {
		...
		case 5:
			...
			(&orig.Body).lazy.Init(buf[startPos:pos], &orig.lazy)
