...
func (orig *ExportProfilesServiceRequest) LazyMessage() *proto.LazyMessage {
	return &orig.lazy
}

// SetLazyParent records the parent lazy state used for modification bubbling.
func (orig *ExportProfilesServiceRequest) SetLazyParent(parent *proto.LazyMessage) {
...
func (orig *ExportProfilesServiceRequest) UnmarshalProto(buf []byte) error {
	if err := validateExportProfilesServiceRequestProto(buf); err != nil {
		return err
	}
	orig.Reset()
...
func (orig *ExportProfilesServiceRequest) EnsureDecoded() {
...
func (orig *ExportProfilesServiceRequest) MarkModified() {
	orig.EnsureDecoded()
...
func (orig *ExportProfilesServiceRequest) DecodeAll() {
	orig.EnsureDecoded()
	for i := range orig.ResourceProfiles {
...
func validateExportProfilesServiceRequestProto(buf []byte) error {
	var err error
	var fieldNum int32
...
func (orig *ExportProfilesServiceRequest) decodeProto(buf []byte) error {
	var err error
	var fieldNum int32
	var wireType proto.WireType
