...
func (orig *ExponentialHistogramDataPoint) LazyMessage() *proto.LazyMessage {
	return &orig.lazy
}

// SetLazyParent records the parent lazy state used for modification bubbling.
func (orig *ExponentialHistogramDataPoint) SetLazyParent(parent *proto.LazyMessage) {
...
func (orig *ExponentialHistogramDataPoint) UnmarshalProto(buf []byte) error {
	if err := validateExponentialHistogramDataPointProto(buf); err != nil {
		return err
	}
	orig.Reset()
...
func (orig *ExponentialHistogramDataPoint) EnsureDecoded() {
...
func (orig *ExponentialHistogramDataPoint) MarkModified() {
	orig.EnsureDecoded()
...
func (orig *ExponentialHistogramDataPoint) DecodeAll() {
	orig.EnsureDecoded()
	for i := range orig.Attributes {
		orig.Attributes[i].DecodeAll()
	}

	orig.Positive.DecodeAll()
	orig.Negative.DecodeAll()
...
func validateExponentialHistogramDataPointProto(buf []byte) error {
	var err error
	var fieldNum int32
	...
	for pos < l {
		...
		case 8:
			...
			startPos := pos - length
			err = validateExponentialHistogramDataPointBucketsProto(buf[startPos:pos])
			if err != nil {
				return err
			}
...
func (orig *ExponentialHistogramDataPoint) decodeProto(buf []byte) error {
	var err error
	var fieldNum int32
	var wireType proto.WireType
	...
	for pos < l {
		...
		case 8:
			...
			(&orig.Positive).lazy.Init(buf[startPos:pos], &orig.lazy)
		...
		case 9:
			...
			(&orig.Negative).lazy.Init(buf[startPos:pos], &orig.lazy)
