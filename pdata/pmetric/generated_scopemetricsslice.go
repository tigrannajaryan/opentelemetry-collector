...
func newScopeMetricsSlice(orig *[]*internal.ScopeMetrics, state *internal.State, marker *internal.LazyMessage) ScopeMetricsSlice {
	return ScopeMetricsSlice{orig: orig, state: state, marker: marker}
}
...
func NewScopeMetricsSlice() ScopeMetricsSlice {
	...
	return newScopeMetricsSlice(&orig, internal.NewState(), nil)
}

func (es ScopeMetricsSlice) markModified() {
	if es.marker != nil {
