...
func newMetricSlice(orig *[]*internal.Metric, state *internal.State, marker *internal.LazyMessage) MetricSlice {
	return MetricSlice{orig: orig, state: state, marker: marker}
}
...
func NewMetricSlice() MetricSlice {
	...
	return newMetricSlice(&orig, internal.NewState(), nil)
}

func (es MetricSlice) markModified() {
	if es.marker != nil {
