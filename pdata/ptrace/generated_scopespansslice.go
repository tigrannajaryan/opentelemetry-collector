...
func newScopeSpansSlice(orig *[]*internal.ScopeSpans, state *internal.State, marker *internal.LazyMessage) ScopeSpansSlice {
	return ScopeSpansSlice{orig: orig, state: state, marker: marker}
}
...
func NewScopeSpansSlice() ScopeSpansSlice {
	...
	return newScopeSpansSlice(&orig, internal.NewState(), nil)
}

func (es ScopeSpansSlice) markModified() {
	if es.marker != nil {
