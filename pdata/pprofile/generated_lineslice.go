...
func newLineSlice(orig *[]*internal.Line, state *internal.State, marker *internal.LazyMessage) LineSlice {
	return LineSlice{orig: orig, state: state, marker: marker}
}
...
func NewLineSlice() LineSlice {
	...
	return newLineSlice(&orig, internal.NewState(), nil)
}

func (es LineSlice) markModified() {
	if es.marker != nil {
