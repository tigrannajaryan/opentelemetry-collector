...
func newResourceProfilesSlice(orig *[]*internal.ResourceProfiles, state *internal.State, marker *internal.LazyMessage) ResourceProfilesSlice {
	return ResourceProfilesSlice{orig: orig, state: state, marker: marker}
}
...
func NewResourceProfilesSlice() ResourceProfilesSlice {
	...
	return newResourceProfilesSlice(&orig, internal.NewState(), nil)
}

func (es ResourceProfilesSlice) markModified() {
	if es.marker != nil {
